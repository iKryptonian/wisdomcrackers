...
const CATEGORY_PRIORITY = [
  ...
  'ROCKETS',
  'SPECIAL SHOWERS',
  'DIGITAL SOUND SERIES',
  'MUSICAL NOVELTIES',
  'PARTY ATTRACTION',
  'TWINKLING STAR',
  'MULTIFUNCTION NOVELTIES',
  'NEW ARRIVAL',
  'BOMBS',
  'KIDS PLAY',
  'CANDLES',
  'GROUND CHAKKAR',
  'FLOWER POT',
  'FLOWER POT (WINDOW BOX)',
  'FANCY',
  '2" PIPE COMMET SINGLE PACK',
  '2" PIPE (3PCS PACKING)',
  '3½" PIPE SINGLE',
  '3½" PIPE MEGA ARRIVAL',
  '4" PIPE MEGA ARRIVAL',
  '4½" PIPE MEGA ARRIVAL',
  '5" SINGLE PIPE',
  'REPEATING SHOT MULTICOLOUR (PREMIUM)',
  'REPEATING SHOT MULTICOLOUR (ECONOMY)',
  'SET OUT',
  'TOY SERIES',
  'MATCHES',
  'GIFT BOX',
