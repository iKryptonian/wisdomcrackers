...
const features = [
  ...
  },
  {
    ...
    desc: "Over 10 years of experience serving households, dealers, and event organizers.",
  },
];

const AboutSection: React.FC = () => (
  <section id="about" className="py-2 sm:py-8 bg-white">
    <div className="max-w-7xl mx-auto px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-12 items-center">
        <div>
          <span className="text-red-600 font-black text-[11px] sm:text-sm uppercase tracking-widest">About Us</span>
          <h2 className="text-xl sm:text-3xl md:text-4xl font-extrabold text-gray-800 mt-1 mb-2 sm:mb-4">
            India's Most Trusted<br />
            <span className="text-red-700">Cracker Retailer</span>
          </h2>
          <p className="text-gray-600 text-xs sm:text-base leading-relaxed mb-1 sm:mb-4">
            Since 2016, we have been bringing joy to millions of Indian households with our premium quality
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="text-center">
              <p className="text-xl sm:text-3xl font-extrabold text-red-700">10+</p>
              <p className="text-gray-500 text-[9px] sm:text-sm">Years Exp.</p>
            </div>
            <div className="w-px h-8 sm:h-12 bg-gray-200" />
            <div className="text-center">
              <p className="text-xl sm:text-3xl font-extrabold text-red-700">5K+</p>
              <p className="text-gray-500 text-[9px] sm:text-sm">Happy Customers</p>
            </div>
            <div className="w-px h-8 sm:h-12 bg-gray-200" />
            <div className="text-center">
              <p className="text-xl sm:text-3xl font-extrabold text-red-700">100+</p>
